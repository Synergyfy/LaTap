                            ...
                            >
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="flex gap-4 pt-4">
                                        ...
                                        <button onClick={nextStep} className="flex-1 h-12 bg-text-main text-white font-bold rounded-xl shadow-lg hover:bg-black transition-all text-sm">Verify & Continue</button>
                                    </div>
                                </div>
                            </motion.div>
                        )}
            ...
            <div className="hidden lg:block lg:w-[40%] bg-gray-50 relative overflow-hidden h-screen">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-12">
                    ...
                    >
                        ...
                        <div className="absolute top-8 left-8 bg-white/80 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/50">
                            <div className="flex items-center gap-3">
                                <div className="size-8 rounded-full bg-green-400/20 text-green-600 flex items-center justify-center">
                                    <span className="material-icons-round text-sm">trending_up</span>
                                </div>
                                <div>
                                    <p className="text-[8px] font-black uppercase text-gray-400 leading-none">Scans Today</p>
                                    <p className="font-display font-black text-sm text-text-main">248</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
