                            ...
                            >
                                ...
                                <div className="space-y-6">
                                    ...
                                    <button
                                        ...
                                        className="w-full h-12 bg-text-main text-white font-bold rounded-xl shadow-lg hover:bg-black transition-all flex items-center justify-center gap-2 text-sm mt-4"
                                    >
                                        Send Recovery Link
