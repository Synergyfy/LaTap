    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="pt-24 pb-12 text-center container mx-auto px-4">
                ...
                <h1 className="text-4xl md:text-5xl font-display font-bold text-text-main leading-tight mb-6 tracking-tight">
                    Simple, transparent pricing <br /> for growing businesses
                </h1>
                <p className="text-base text-text-secondary max-w-2xl mx-auto font-medium leading-relaxed">
            ...
            <section className="py-20 bg-white border-t border-gray-50">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <div className="grid gap-4 text-left">
                        {[
                            { q: "How does the redirection work?", a: "Each VemTap tag can be configured in your dashboard to point to any URL. You can update these links instantly at any time." },
                            ...
                            { q: "Do I need special hardware?", a: "Our service works with standard NFC tags. You can use your own or obtain our high-durability VemTap tags to ensure the best customer experience." }
                        ].map((item, i) => (
                            <div key={i} className="p-5 rounded-xl bg-gray-50 border border-gray-100">
                                <h4 className="font-bold text-text-main mb-2 text-sm">{item.q}</h4>
                                <p className="text-xs text-text-secondary font-medium leading-relaxed">{item.a}</p>
                            </div>
                        ))}
                    </div>
                </div>
